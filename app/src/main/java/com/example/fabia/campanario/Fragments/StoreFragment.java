...
public class StoreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        storeAdapter = new StoreAdapter(this.getActivity(), loadStore2());
    ...
    private void saveStore() {
       ...
       Store store2=new Store("Copoazu", "323-30-9237", "Local: (Kiosko Techo) KT4", "https://campanariopopayan.com/images/tiendas/tiendas/copoazu.png");
        ...
        PertaintoCategory pertaintoCategory1=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store1);
        PertaintoCategory pertaintoCategory2=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store1);
        PertaintoCategory pertaintoCategory3=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store1);
        PertaintoCategory pertaintoCategory4=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store1);
        PertaintoCategory pertaintoCategory5=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store6);
        PertaintoCategory pertaintoCategory6=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store7);
        PertaintoCategory pertaintoCategory7=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store8);
        PertaintoCategory pertaintoCategory8=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store9);
        PertaintoCategory pertaintoCategory9=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store10);
        PertaintoCategory pertaintoCategory10=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store11);
        PertaintoCategory pertaintoCategory11=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store11);
        PertaintoCategory pertaintoCategory12=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store12);
        PertaintoCategory pertaintoCategory13=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store13);
        PertaintoCategory pertaintoCategory14=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store14);
        PertaintoCategory pertaintoCategory15=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store15);
        PertaintoCategory pertaintoCategory16=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store16);
        PertaintoCategory pertaintoCategory17=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store17);
        PertaintoCategory pertaintoCategory18=new PertaintoCategory(Category.findByName(getString(R.string.menu_title_food_drink)),store18);
