...
public class DirectoryFragment extends Fragment {
    ...
    private ListView list_directory;
    private SearchView search_contact;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View viewDirectory=inflater.inflate(R.layout.fragment_directory, container, false);
        listStores=loadStore();
        list_directory=(ListView)viewDirectory.findViewById(R.id.list_directory);
        final NumberPhoneAdapter adapterNumberPhone=new NumberPhoneAdapter(this.getActivity(),listStores);
        search_contact=(SearchView)viewDirectory.findViewById(R.id.searchView);
       // .addTextChangedListener(new SearchMovieTextWatcher(adapterMovie,listStores));
        list_directory.setAdapter(adapterNumberPhone);
        search_contact.setQueryHint("Buscar tienda");

        search_contact.setOnQueryTextListener(new SearchView.OnQueryTextListener() {

            @Override
            public boolean onQueryTextSubmit(String query) {
                adapterNumberPhone.getFilter().filter(query.toString().toLowerCase());
                list_directory.setAdapter(adapterNumberPhone);
                return false;
            }
            ...
            public boolean onQueryTextChange(String newText) {
                adapterNumberPhone.getFilter().filter(newText.toString().toLowerCase());
                list_directory.setAdapter(adapterNumberPhone);
                return false;
            }
        });
    ...
    public ArrayList<Store> loadStore(){
        ...
        listStore.add(new Store("Copoazu", "323309237", "Local: (Kiosko Techo) KT4","https://campanariopopayan.com/images/tiendas/tiendas/copoazu.png"));
        ...
        listStore.add(new Store("Helados POPSY", "3143590967", "Local: 49","https://campanariopopayan.com/images/tiendas/tiendas/helados-popsy-1371575109.jpg"));
        ...
        listStore.add(new Store("San Blas", "3014322370", "Local: (Kiosko bar) KB4","https://campanariopopayan.com/images/tiendas/tiendas/san-blass.png"));
        ...
        listStore.add(new Store("Tierra Blanca", "3127650199", "Local: (Kiosko Bar) KB5","https://campanariopopayan.com/images/tiendas/tiendas/tierra-blanca.png"));
        ...
        listStore.add(new Store("Perfumex", "3153492676", "Local: (Kiosko Techo) KT6","https://campanariopopayan.com/images/tiendas/tiendas/perfumex.png"));
        ...
        listStore.add(new Store("Amadeo Cerón Abogados", "8234091,3206897414", "Local: Oficina 205","https://campanariopopayan.com/images/tiendas/tiendas/tienda-campanario.jpg"));
        ...
        listStore.add(new Store("Jumbo", "018000112036", "Local:", "https://campanariopopayan.com/images/tiendas/categorias/hipermecado-1371581913.jpg"));
